...
mysql_select_db("carritocompras", $link); 
...
$myusuario = mysql_query("select idusuario from usuarios where idusuario = '".$_POST["usuario"]."'",$link); 
$nmyusuario = mysql_num_rows($myusuario); 

//Si existe el usuario, validamos también la contraseña ingresada y el estado del usuario... 
if($nmyusuario != 0)
{ 
  $sql = "select idusuario from usuarios where estado = 1 and idusuario = '".$_POST["usuario"]."' and clave = '".md5(htmlentities($_POST["clave"]))."'"; 
